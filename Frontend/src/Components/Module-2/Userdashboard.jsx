  ...
  return (
    <div className="p-6 max-w-4xl mx-auto space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <Link to="/userpannel/Avaibledoctorlist" className="bg-slate-800 p-8 rounded-2xl flex items-center justify-between group transition hover:bg-slate-900 shadow-sm">
          <div>
