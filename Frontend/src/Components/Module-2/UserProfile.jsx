      ...
      <div className="max-w-5xl mx-auto space-y-8">
        ...
        <div className="bg-white rounded-3xl border border-slate-200 p-8 shadow-sm relative flex flex-col md:flex-row items-center gap-8">
          ...
          <div className="w-32 h-32 rounded-full bg-emerald-100 flex items-center justify-center border-4 border-white shadow-inner">
            <span className="text-emerald-700 text-4xl font-black">
              {initials}
            </span>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-3xl border border-slate-200 p-8 shadow-sm">
            <h3 className="text-sm font-black text-slate-400 uppercase mb-6 tracking-widest">
              Medical Context
            </h3>
            ...
            <div className="space-y-4">
              <DetailField
                label="Account ID"
                value={`#USR-${user.full_name.slice(0, 3).toUpperCase()}`}
              />
          ...
          <div className="bg-white rounded-3xl border border-slate-200 p-8 shadow-sm">
            ...
            <p className="text-slate-600 text-sm leading-relaxed">
              Your profile is currently active. All triage sessions linked to{" "}
              <strong>{user.email}</strong> are visible in your history tab.
            </p>
          </div>
        </div>
      </div>
